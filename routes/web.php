...
Route::middleware('redirect')->group(function () {
    ...
    Route::domain('{city}.' . SITE)->group(function () {
        ...
        Route::get('/{slug}', [\App\Http\Controllers\CategoryController::class, 'index'])
            ->where('slug', '^(metro|rayon|national|service|place|time|hair|intimhair|price|vozrast|vneshnost)$');

        Route::get('/{section}/{slug}',[\App\Http\Controllers\FilterController::class, 'slug'])
            ->where('section', '^(metro|rayon|national|service|place|time|hair|intimhair|price|vozrast|vneshnost)$');
