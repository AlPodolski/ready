...
class ImportPosts extends Command
{
    ...
    public function handle()
    {
        ...
        $stream = \fopen(storage_path('import_19_11_2025.csv'), 'r');
        ...
        foreach ($posts as $city => $postsList) {

            if (isset($cityTraslit[$city])) {

                $cityInfo = City::where('city', $cityTraslit[$city])->first();

                foreach ($postsList as $record) {

                    $sort = rand(0, 1755077259);
